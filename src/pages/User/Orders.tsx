                  ...
                  <IonCardContent style={{ padding: '10px' }}>
                    ...
                    <div style={{ marginBottom: '16px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', alignItems: 'center' }}>
                        ...
                        <span style={{ fontSize: '12px', color: 'var(--ion-text-color-secondary)' }}>
                          {getProgressPercentage(order.vendorStatus, order.riderStatus)}%
                        </span>
                      </div>
                      <div style={{ height: '6px', background: 'var(--ion-border-color)', borderRadius: '3px', overflow: 'hidden' }}>
                        <div
                          style={{
                            height: '100%',
                            width: `${getProgressPercentage(order.vendorStatus, order.riderStatus)}%`,
                    ...
                    {/* Tracking Steps */}
                    <div style={{ marginBottom: '16px' }}>
                      <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto 1fr auto 1fr auto 1fr', gap: '8px', alignItems: 'center' }}>
                        {/* Received */}
                        <div style={{ textAlign: 'center' }}>
                          <div style={{
                            width: '24px',
                            ...
                            <IonIcon icon={checkmarkCircle} style={{ fontSize: '16px', color: 'white' }} />
                          </div>
                          <p style={{ margin: 0, fontSize: '10px', color: 'var(--ion-text-color-secondary)' }}>Received</p>
                        </div>
                        ...
                        <div style={{ textAlign: 'center' }}>
                          ...
                          <p style={{ margin: 0, fontSize: '10px', color: 'var(--ion-text-color-secondary)' }}>Preparing</p>
                        </div>
                        ...
                        <div style={{ textAlign: 'center' }}>
                          ...
                          <p style={{ margin: 0, fontSize: '10px', color: 'var(--ion-text-color-secondary)' }}>Pickup</p>
                        </div>
                        ...
                        <div style={{ textAlign: 'center' }}>
                          <div style={{
                            ...
                            {order.riderStatus === 'delivered' && (
                              <IonIcon icon={checkmarkDoneOutline} style={{ fontSize: '16px', color: 'white' }} />
                            )}
                          </div>
                          <p style={{ margin: 0, fontSize: '10px', color: 'var(--ion-text-color-secondary)' }}>Delivered</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Action Button */}
                    {order.riderStatus !== 'delivered' && (
                      <IonButton expand="block" color="primary" fill="outline" size="small">
                        Live Tracking
                      </IonButton>
                    )}
                  </IonCardContent>
